...
<body>
    ...
    <div class="container-fluid p-5 mb-5 bg-dark text-secondary">
        <div class="row g-5 py-5">
            <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-1 text-secondary text-center mb-0">Input Transaksi</h1>
            </div>
           <div class="container">
    </div>
    ...
    <!-- Menu End -->
<?php
// Pastikan ini adalah baris pertama file, tanpa spasi/karakter sebelumnya
                    ...
                    <div class="card shadow">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted">ID Transaksi: 
                                    <strong id="transaction-id"><?= $_SESSION['current_transaction']['id'] ?? 'Belum dibuat' ?></strong>
                                </p>
                            </div>
                            ...
                            <form id="add-item-form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah" placeholder="Jumlah" min="1" value="1" required>
                                    </div>
                                </div>
                            ...
                            <div id="transaction-section" class="<?= empty($_SESSION['current_transaction']['items']) ? 'd-none' : '' ?>">
                                <hr>
                                <h5 class="mb-3">Item dalam Transaksi:</h5>
                                <div id="items-container">
                                    <table class="table table-sm">
                                        ...
                                        <tbody id="items-list">
                                            <?php if (!empty($_SESSION['current_transaction']['items'])): ?>
                                                <?php foreach ($_SESSION['current_transaction']['items'] as $item): ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <h5>Total: <span id="total-amount">Rp <?= 
                                        !empty($_SESSION['current_transaction']['items']) ? 
                                        number_format(array_sum(array_column($_SESSION['current_transaction']['items'], 'subtotal')), 0, ',', '.') : 
                                        '0' 
                                    ?></span></h5>
                                    <button id="save-transaction" class="btn btn-success">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('#transaction-section').removeClass('d-none');
                ...
                error: function() {
                    showAlert('Terjadi kesalahan saat menambahkan item', 'danger');
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        // Reset tampilan
                        setTimeout(function() {
                            $('#transaction-id').text('Belum dibuat');
                            $('#items-list').empty();
                            $('#total-amount').text('Rp 0');
                            $('#transaction-section').addClass('d-none');
                        }, 1500);
                    } else {
                        showAlert(response.message, 'danger');
                    }
